---
title: "69_claude-code-prompt-improver 曖昧指示を送信瞬間に補完（出典）"
tags: [raw-source]
...
- URL: https://x.com/opensourcelab9/status/2083681691537961218
- 著者: opensourcelab9（@opensourcelab9）
- 公開: 2026年8月2日
- 形態: X ポスト（ツール紹介）
- リポジトリ: https://github.com/severity1/claude-code-prompt-improver（★1831・MIT・Python）
- タイトル: **claude-code-prompt-improver** — Claude Code に雑に投げた一言を送信瞬間に「足りない前提」ごと渡し直すフック

要約は [[05_claude-code-prompt-improver 送信瞬間に前提を補完]] を参照。

---

# 原文（@opensourcelab9 の X ポスト全文）
