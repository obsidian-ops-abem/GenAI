...
要約は [[05_Vibe Kanban コーディングエージェント用Kanbanワークスペース]] を参照。
...
- エージェント並列実行のワークスペース分離 → [[10_1チャットをエージェントチームへ Opus5 12ステップ]]（worktree隔離）・[[29_A Graph of Loops（仮）]]（agent-worktree G2）
