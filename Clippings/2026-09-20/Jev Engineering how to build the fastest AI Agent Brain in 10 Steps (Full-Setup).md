...
tags:
  - "clippings"
---
![画像](https://pbs.twimg.com/media/HShGxV4XgAA2JRK?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HSg_UN1WQAA1vtW?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HSg7Jn3W0AEh1JU?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HSg_2kNXIAAs1Xm?format=png&name=large)
...
![画像](https://pbs.twimg.com/media/HSg8c5IXgAARk_C?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HShBwFSW4AA9z4p?format=jpg&name=large)
...
![画像](https://pbs.twimg.com/media/HSg8_FqWsAAg2oG?format=png&name=large)
...
![画像](https://pbs.twimg.com/media/HSg9IGgW8AARuSJ?format=png&name=large)
...
<video preload="auto" tabindex="-1" playsinline="" aria-label="埋め込み動画" poster="https://pbs.twimg.com/tweet_video_thumb/HShCJzzXAAAu7lk.jpg" src="https://video.twimg.com/tweet_video/HShCJzzXAAAu7lk.mp4" type="video/mp4" style="width: 100%; height: 100%; position: absolute; background-color: black; top: 0%; left: 0%; transform: rotate(0deg) scale(1.005);"></video>
...
![画像](https://pbs.twimg.com/media/HSg9al7XkAAN46S?format=png&name=large)
...
![画像](https://pbs.twimg.com/media/HShCnOXXAAANQKz?format=png&name=large)
...
![画像](https://pbs.twimg.com/media/HSg-DDZW8AAjsZw?format=png&name=large)
...
![画像](https://pbs.twimg.com/media/HShCz1EXYAA5L7k?format=png&name=large)
...
![画像](https://pbs.twimg.com/media/HShDN30XcAAoiHx?format=jpg&name=large)
...
> 9月16日
> 
> 私たちは、未来はコード＋AIだと信じているので、それを反映したワークフローの評価を作成しました。 Jevのコスト：10億入力トークンあたり42ドル（0.042ドル / MTok）、出力トークンは無料（永久に - 新しいアーキテクチャではあまりにも安価すぎて課金計測ができません）
...
> 9月18日
> 
> Jev + Kimi K3で詐欺検知！ TLDR: Jevが100件のメールを1.42秒で分類し、その後不確かなケースをKimi K3にルーティングしました。全体のパイプラインは96/100件正解で、コストはわずか~$0.07です。 ビデオは速度調整していません。ライブ実行をご覧ください！ 私のプロセスは以下の通りです：
...
> 9月17日
> 
> @typesafeaiのJevはめっちゃクールだよ。500通のメールを数秒で分類してくれた。しかも3.5セントしかかからなかった。
