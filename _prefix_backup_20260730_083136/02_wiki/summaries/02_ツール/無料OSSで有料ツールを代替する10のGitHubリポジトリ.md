---
title: "無料OSSで有料ツールを代替する10のGitHubリポジトリ"
...
> 詳細メタデータ: [[33 Free GitHub Repositories（出典）]]
...
- [ ] `anthropics/skills` と `awesome-mcp-servers` を実際に覗き、このボルトのCLAUDE.md運用や[[intent-system 意図駆動開発のオーケストレーションCLI]]の話に転用できるものがないか確認する
